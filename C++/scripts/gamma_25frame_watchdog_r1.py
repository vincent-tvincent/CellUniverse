#!/usr/bin/env python3
"""Early-prune watchdog for gamma_25frame_tuning_r1.py.
...
REPO_DRIVER = Path('/home/puv/celluniverse/CellUniverse/C++/scripts/gamma_25frame_tuning_r1.py')
SLEEP_SECONDS = 30
...
def main():
    ...
    append_log('Started gamma watchdog r1', [
    ...
    while True:
        ...
        if complete and not active_controller_alive():
            append_log('Stopped gamma watchdog r1', ['controller complete and no active auto driver found'])
            return
