...
ROOT = Path('/home/puv/output_fluo/tuning_fluo_gt_20260529/gamma_25frame_original_n2v2_r1')
...
def auto():
    ensure_dirs()
    append_log('Started gamma 25-frame tuning r1', [
    ...
    append_log('Completed gamma 25-frame tuning r1', [f'metrics: `{METRICS}`', f'summary: `{SUMMARY}`', f'relation: `{RELATION}`'])
