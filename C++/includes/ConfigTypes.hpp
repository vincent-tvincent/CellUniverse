...
public:
    ...
    bool export_signal_center_images = false;
    ...
    float adaptive_cube_pooling_strong_peak_threshold = 0.12f;
    ...
    void explodeConfig(const YAML::Node& node) {
        ...
        if (node["export_signal_center_images"]) export_signal_center_images = node["export_signal_center_images"].as<bool>();
        ...
        if (node["adaptive_cube_pooling_strong_peak_threshold"]) adaptive_cube_pooling_strong_peak_threshold = node["adaptive_cube_pooling_strong_peak_threshold"].as<float>();
    ...
    void printConfig() const {
        ...
        std::cout << "export_signal_center_images: " << export_signal_center_images << '\n';
        ...
        std::cout << "adaptive_cube_pooling_strong_peak_threshold: " << adaptive_cube_pooling_strong_peak_threshold << '\n';
