...
echo "*******************************************************************************************************"
echo "Cell Universe Original Data Run (clean + rebuild + run)  [OLD / CELL UNIVERSE]"
echo "*******************************************************************************************************"
...
echo "[STEP] Running tracker (OLD / CELL UNIVERSE)..."
